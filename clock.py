...
left_hand = pygame.image.load("firsthand.png")
left_hand = pygame.transform.scale(left_hand, (50, 200))

right_hand = pygame.image.load("secondhand.png")
right_hand = pygame.transform.scale(right_hand, (50, 00))
